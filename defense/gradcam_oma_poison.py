...
def main():
    ...
    target_class = 14
    epsilon = 0.08
    save_dir = "defense_results/gradcam_oma_poison"
    num_samples = 10
    # =========================
    ...
    for sample_index in range(num_samples):
        ...
        clean_cam_path = os.path.join(save_dir, f"sample_{sample_index:03d}_clean_gradcam_class{target_class}.jpg")
        ...
        poison_cam_path = os.path.join(save_dir, f"sample_{sample_index:03d}_poisoned_gradcam_class{target_class}.jpg")
