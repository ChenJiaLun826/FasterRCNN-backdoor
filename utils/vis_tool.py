...
class Visualizer(object):
    ...
    def __init__(self, env='default', **kwargs):
        self.vis = visdom.Visdom('localhost', port=6006, env=env, use_incoming_socket=False, **kwargs)
        self._vis_kw = kwargs
    ...
    def reinit(self, env='default', **kwargs):
        ...
        """
        self.vis = visdom.Visdom(server='http://localhost', port=6006, env=env, **kwargs)
        return self
    ...
    def load_state_dict(self, d):
        self.vis = visdom.Visdom(server='http://localhost', port=6006, env=d.get('env', self.vis.env), **(self.d.get('vis_kw')))
